...
namespace WindowsFormsApplication3
{
    public partial class Play : Form
    {
        ...
        private void progress()
        {
            ...
            label4.Location = new Point(176, 180 - floatPostion);
        }
        ...
        private void PlayOrPause()
        {
            if (axWindowsMediaPlayer1.playState.ToString() == "wmppsPlaying")
            {
                ...
                panel3.BackgroundImage = new System.Drawing.Bitmap(@"Pause.png");
            }
            else
            {
                axWindowsMediaPlayer1.Ctlcontrols.play();
                panel3.BackgroundImageLayout = ImageLayout.Stretch;
                panel3.BackgroundImage = new System.Drawing.Bitmap(@"Play.png");
            }
        }
        ...
        private void Next()
        {
            ...
            listBox2.SelectedIndex = listBox2.SelectedIndex + 1;//listbox中选择的数加1
            string path = this.listBox1.Items[listBox2.SelectedIndex].ToString();
        ...
        private void saveData()
        {
            ...
            foreach (object item1 in listBox2.Items)
            {
        ...
        private void read()
        {
            ...
            WebRequest wr = WebRequest.Create("http://shaoshixiong.eicp.net/d/");
            ...
            {
                listBox1.Items.Add("http://shaoshixiong.eicp.net/d" + item.Substring(0, item.IndexOf("\"")));
                listBox2.Items.Add(item.Substring(item.IndexOf("\"") + 6));
        ...
        {
            int index2 = this.listBox2.SelectedIndex;
        ...
        {
            soure = this.listBox1.Items[listBox2.SelectedIndex].ToString();
